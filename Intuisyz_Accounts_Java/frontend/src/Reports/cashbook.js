...
const Cashbook = () => {
    ...
    .map((item) => {
      return (
        <tr key={item.tranID}>
          ...
          {console.log('line 249 debitDropDownFlag ',debitDropDownFlag,'item.type ',item.type,'item.amount ',item.amount)}
          {creditDropDownFlag && (
            <td>
              {item.type === 'Nil' && ''}
              {item.type === 'Receipt' && '-'}
  ...
  const dataLoading = async () => {
    axios
      ...
      .then(({ data }) => {
        console.log('line 870 data', data,' data.length ',data.length);
  ...
  function dataLoading1() {
    ...
    .get(
      ...
      .then(({ data }) => {
        setFlag(1);
        console.log('line 966 data ',data);
                          ...
                          {flag === 1 && (
                            <>
                              <tr>
                                ...
                                <td />
                                <td />
                                <td>Opening balance</td>{console.log('line 1766 openBalanceData ',openBalanceData,' openBalanceData[0].obBalance_type ',openBalanceData[0].obBalance_type)}
                                <td align="center">
