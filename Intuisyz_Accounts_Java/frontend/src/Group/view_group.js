...
const View_group = () => {
  ...
  function dataLoading() {
    ...
    let cshid = sessionStorage.getItem('cashId');
    let gid = sessionStorage.getItem('gstId');
    let tdid = sessionStorage.getItem('tdsId');
    console.log('line 38 custid ',custid,' cshid ',cshid,' gid ',gid,' tdid ',tdid);
    axios
