...
import { profit_loss_bn_date } from '../modal';
...
const Profit_loss = () => {
  ...
  const submitFinal = handleSubmit(async (data) => {
    if (startDate === null || startDate === undefined) {
      ...
      console.log('line 100 sDate ',sDate, ' eDate ', eDate);
  ...
  const filterFun = async () => {
    ...
    console.log('line 184 startdate ', startdate,' end date ', enddate);
    console.log('line 185 dateVal ',dateVal);

    if (dateVal === '0') {
      // This Month
      startdate.setDate(1);
      console.log('line 189 startdate',startdate);
    }
    ...
    if (dateVal === '1') {
      ...
      console.log('line 222 startdate',startdate,' enddate ',enddate);
    }
    ...
    if (dateVal === '2') {
      ...
      console.log('line 216 startdate',startdate,' enddate ',enddate);
    }
    ...
    if (dateVal === '3') {
      ...
      console.log('line 235 startdate',startdate,' enddate ',enddate);
    }
    ...
    if (dateVal === '5')
    {
      ...
      startdate.setMonth(3);
      startdate.setDate(1);
      console.log('line 284 startdate ',startdate,' enddate ',enddate);
      ...
      console.log('line 290 startdate ',startdate,' enddate ',enddate);
    }
    ///////////////////new code//////////////////
    ...
    if (startdate.getDate() < 10) {
      var currentDay = '0' + startdate.getDate();
      console.log('line 384 currentDay ',currentDay);
    } else {
      var currentDay = startdate.getDate();
      console.log('line 387 currentDay ',currentDay);
    }

    if (startdate.getMonth() + 1 < 10) {
      var currentMonth = '0' + (startdate.getMonth() + 1);
      console.log('line 392 currentMonth ',currentMonth);
    } else {
      var currentMonth = startdate.getMonth() + 1;
      console.log('line 395 currentMonth ',currentMonth);
    }

    var sDate = startdate.getFullYear() + '-' + currentMonth + '-' + currentDay;
    console.log('line 399 sDate ',sDate);
    if (enddate.getDate() < 10) {
      var currentDay = '0' + enddate.getDate();
      console.log('line 402 currentDay ',currentDay);
    } else {
      var currentDay = enddate.getDate();
      console.log('line 405 currentDay ',currentDay);
    }

    if (enddate.getMonth() + 1 < 10) {
      var currentMonth = '0' + (enddate.getMonth() + 1);
      console.log('line 410 currentMonth ',currentMonth);
    } else {
      var currentMonth = enddate.getMonth() + 1;
      console.log('line 413 currentMonth ',currentMonth);
    }

    var eDate = enddate.getFullYear() + '-' + currentMonth + '-' + currentDay;
    console.log('line 417 eDate ',eDate);

    console.log('line 419 sDate ',sDate, ' eDate ', eDate);
  ...
  const dataLoading = async () => {
    let mgrDate = localStorage.getItem('migrationDate');
    var today = new Date();
    console.log("line 428 today ",today);
    console.log("line 429 mgrDate ",mgrDate);
    if (today.getDate() < 10) {
    ...
    console.log('line 444 today ',today, ' mgrDate ', mgrDate);
    try {
      const result = await profit_loss_bn_date({
        title: '6',
        start: mgrDate,
