      ...
      .then(({ data }) => {
        ...
        axios
          ...
          .then(({ data }) => {
            ...
            if (data.ac_type ==='2' || data.ac_type ==='3')
            {
              finalObj1.debit_blnc_after_txn = parseFloat(finalObj1.debit_blnc_bfore_txn) - parseFloat(finalObj1.amount);;
            }
            else
            {
              finalObj1.debit_blnc_after_txn = parseFloat(finalObj1.debit_blnc_bfore_txn) + parseFloat(finalObj1.amount);;
        ...
        axios
          ...
          .then(({ data }) => {
            ...
            if (type === '2' || type === '3') {
              ...
              finalAmount1 = parseFloat(previousAmount1) - parseFloat(a1) + parseFloat(journalAmount);
            } else {
              let previousAmount1 = data[0].amount;
              finalAmount1 = parseFloat(previousAmount1) + parseFloat(ledgerAmount);
            }
      ...
      .then(({ data }) => {
        ...
        axios
          ...
          .then(({ data }) => {
            ...
            if (type === '2' || type === '3') {
              let previousAmount1 = data[0].amount;
              finalAmount1 = parseInt(previousAmount1) - parseInt(a1) + parseInt(journalAmount);
            } else {
              let previousAmount1 = data[0].amount;
