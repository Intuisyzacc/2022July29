...
const Edit_receipt = () => {
  ...
  const submitFinal = handleSubmit((data) => {
    console.log('line 59 data',data,'tranIDData ',tranIDData,'transactionIdData ',transactionIdData);
    tranID = tranIDData;
    transactionId = transactionIdData;
    console.log('line 62 tranID',tranID,'transactionId ',transactionId);
    ...
    console.log('line 101 date', cTime, 'time ',cDate);
    ...
    //     console.log(err);
    //   });
    console.log('line 113 endDate', endDate);
    console.log('line 114 chequeDate', chequeDate);
    ...
    if (data.mode === 'cheque') {
      if (
        ...
        let finalObj1 = {};
        console.log('line 217 data.mode', data.mode);

        finalObj1.transactionID = uuid();
        finalObj1.crdt_ac = data.ledger;
        finalObj1.dbt_ac = data.bank;
        ...
        finalObj1.tran_gen = invoiceTransactionIdData; //      not used , but in table
        ...
        axios
          ...
          .then(({ data }) => {
            console.log('line 250 transaction data', data);
            ...
            if (finalObj1.status === 'Recieve' || finalObj1.status === '1') {
              if (Mode === 'cash') {
                //let ledgerID11 = '30';
                ...
                axios
                  ...
                  .then(({ data }) => {
                    console.log('line 277 data', data);
                    previousAmount = data[0].amount;
                    finalAmount = parseFloat(previousAmount) - parseFloat(amount1);

                    finalObj1.debit_blnc_bfore_txn = finalAmount;
                    finalObj1.debit_blnc_after_txn = parseFloat(finalAmount) + parseFloat(finalObj1.amount);
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        console.log('line 315 grpId', data);
                        ...
                        axios
                          ...
                          .then(() => {
                            console.log('line 324 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                        ...
                        console.log('line 336 updatesLedger1 finalObj6', finalObj6);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
                ...
                axios
                  ...
                  .then(({ data }) => {
                    ...
                    finalAmount1 = parseFloat(previousAmount1) + parseFloat(amount1);
                    
                    finalObj1.credit_blnc_bfore_txn = finalAmount1;
                    finalObj1.credit_blnc_after_txn = parseFloat(finalAmount1) - parseFloat(finalObj1.amount);
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          ...
                          .then(() => {
                            console.log('line 401 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                        ...
                        console.log('line 408 updatesLedger2 finalObj2', finalObj2);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
                ...
                axios
                  ...
                  .then(({ data }) => {
                    ...
                    let finalAmount = parseFloat(previousAmount) - parseFloat(amount1);
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj6.id}`, finalObj6)
                          .then(() => {
                            console.log('line 469 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                            //     pathname: '/view_journal',
                        ...
                        console.log('line 481 updatesLedger1 finalObj6', finalObj6);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj2.id}`, finalObj2)
                          .then(() => {
                            console.log('line 546 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                        ...
                        console.log('line 553 updatesLedger2 finalObj2', finalObj2);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
              ...
              axios
                ...
                .then(({ data }) => {
                  add();
                  console.log('line 569 deleted data', data);
                  console.log('line 570 Deleted Succesfully');
                  // setTimeout(function () {
                  //   history.push({
                  //     pathname: '/view_group',
                  //   });
              ...
              function add() {
                axios
                  ...
                  .then(() => {
                    // setFlag(1);
                    console.log('line 589 new transaction added ', data);
                    // successToast('Payment Updated Successfully');
                    increaseAmount(finalObj1.dbt_ac,finalObj1.amount,cDate,cTime,'');
            ...
            /////else part not done beacause of sundry field
          })
          .catch((err) => {
            console.log(err);
          });
        ...
        console.log('line 622 FinalObj1', finalObj1);
        console.log('line 623 tran date', finalObj1.tran_Date);
        console.log('line 624 cheque__Date', finalObj1.chq_date);
      ...
      if (
        ...
        let finalObj1 = {};
        console.log('line 689 data.mode', data.mode);
        ...
        axios
          .get(url + `journal_search?tranId=${tranID}`)
          .then(({ data }) => {
            console.log('line 722 transaction data', data);
            amount1 = data[0].amount;
            Mode = data[0].mode;
            let crdtAmountac = data[0].crdt_ac;
            let bankledger = data[0].bank;
            ...
            if (finalObj1.status === 'Recieve' || finalObj1.status === '1') {
              if (Mode === 'cash') {
                ...
                axios
                  ...
                  .then(({ data }) => {
                    ...
                    console.log('line 752 data ', data);
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj6.id}`, finalObj6)
                          .then(() => {
                            console.log('line 797 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                            //     pathname: '/view_journal',
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj2.id}`, finalObj2)
                          .then(() => {
                            console.log('line 873 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                ...
                axios
                  .get(url + `ledger_search?ledgerId=${bankledger}`)
                  .then(({ data }) => {
                    console.log('line 894 data ',data);
                    let previousAmount = data[0].amount;
                    let finalAmount = parseFloat(previousAmount) - parseFloat(amount1);
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj6.id}`, finalObj6)
                          .then(() => {
                            console.log('line 942 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                            //     pathname: '/view_journal',
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj2.id}`, finalObj2)
                          .then(() => {
                            console.log('line 1019 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                        ...
                        console.log('line 1026 updatesLedger2 finalObj2', finalObj2);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
              ...
              axios
                ...
                .then(({ data }) => {
                  add();
                  console.log('line 1042 deleted data', data);
                  console.log('line 1043 Deleted Succesfully');
                  // setTimeout(function () {
                  //   history.push({
                  //     pathname: '/view_group',
                  //   });
              ...
              function add() {
                axios
                  ...
                  .then(() => {
                    // setFlag(1);
                    console.log('line 1062 new transaction added ', data);

                    invoiceFun(finalObj1.amount);
                    // successToast('Payment Updated Successfully');
                    increaseAmount(finalObj1.dbt_ac,finalObj1.amount,cDate,cTime,'');
      ...
      if (endDate === null || endDate === undefined) {
        ...
        finalObj1.crdt_ac = data.ledger;
        //finalObj1.dbt_ac = '30';
        finalObj1.dbt_ac = sessionStorage.getItem('cashIdVal');
        // finalObj1.crdt_ac = arr[0].ac_title;
        finalObj1.mode = data.mode;
        finalObj1.amount = data.amount;
        finalObj1.type = 'Receipt'; //transactionType
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj6.id}`, finalObj6)
                          .then(() => {
                            console.log('line 1261 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                            //     pathname: '/view_journal',
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj2.id}`, finalObj2)
                          .then(() => {
                            console.log('line 1338 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                        ...
                        console.log('line 1345 updatesLedger2 finalObj2', finalObj2);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj6.id}`, finalObj6)
                          .then(() => {
                            console.log('line 1407 updatesLedger1 Updated Successfully');
                            // reset();
                            // setTimeout(function () {
                            //   history.push({
                            //     pathname: '/view_journal',
                    ...
                    axios
                      ...
                      .then(({ data }) => {
                        ...
                        axios
                          .put(url + `ledger_update/${finalObj2.id}`, finalObj2)
                          .then(() => {
                            console.log('line 1484 updatesLedger2 Updated Successfully');
                            // reset();
                          })
                          .catch((err) => {
                            console.log(err);
                        ...
                        console.log('line 1491 updatesLedger2 finalObj2', finalObj2);
                      })
                      .catch((err) => {
                        console.log(err);
                      });
        ...
        console.log('line 1562 FinalObj1', finalObj1);
        console.log('tran date', finalObj1.tran_Date);
        console.log('cheque__Date', finalObj1.chq_date);
      }
    }
  ...
  function invoiceFun(journalAmount) {
    ...
    axios
      .get(
        url +
          `invoiceDataByTransactionId?transactionId=${invoiceTransactionIdData}`
      )
      .then(({ data }) => {
        console.log('line 1580 invoice function data', data);

        console.log('line 1582 data[0].inv_id ', data[0].inv_id);
        invId = data[0].inv_id;
        ...
        finalObj1.amount_received = journalAmount;
        ...
        axios
          ...
          .then(() => {
            console.log('line 1627 invoice Updated Successfully');
          })
          .catch((err) => {
            console.log(err);
          });
  ...
  function increaseAmount(ledgerID, ledgeramount, created_date, time, userID) {
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        console.log('line 1649 increase function updatedAmount', updatedAmount);
        ...
        axios
          .get(url + `grp_by_id?grpId=${data[0].ac_group}`)
          .then(({ data }) => {
            console.log('line 1685 grpId', data);
            ...
            axios
              ...
              .then(() => {
                console.log('line 1694 increaseAmount Updated Successfully');
                // reset();
                // setTimeout(function () {
                //   history.push({
                //     pathname: '/view_journal',
            ...
            console.log('line 1706 increaseAmount finalObj3', finalObj3);
          })
          .catch((err) => {
            console.log(err);
          });
  ...
  function decreaseAmount(ledgerID, ledgeramount, created_date, time, userID) {
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        updatedAmount = parseFloat(currentAmount) - parseFloat(ledgeramount);
        console.log('line 1728 decrease function updatedAmount', updatedAmount);
        ...
        axios
          .get(url + `grp_by_id?grpId=${data[0].ac_group}`)
          .then(({ data }) => {
            console.log('line 1764 grpId', data);
            ...
            axios
              ...
              .then(() => {
                console.log('line 1773 decreaseAmount Updated Successfully');
                // reset();
                // setTimeout(function () {
                //   history.push({
                //     pathname: '/view_journal',
            ...
            console.log('line 1785 decreaseAmount finalObj4', finalObj4);
          })
          .catch((err) => {
            console.log(err);
          });
  ...
  const bankNameLoading = () => {
    axios
      ...
      .then(({ data }) => {
        console.log('line 1825 data ',data);
        setBankName(data);
  ...
  const uploadImage = async (file) => {
    try {
      ...
      console.log('response.data.fileDownloadUri',response.data.fileDownloadUri);
  ...
  useEffect(() => {
    if (sessionStorage.getItem('logDetails') === 'true') {
      if (location.post === undefined || location.post === null) {
        ...
        setInvoiceTransactionIdData(location.post.tran_gen);
                ...
                <div className="col-sm-12">
                  ...
                  <div className="box-content">
                    ...
                    >
                      <div className="row">
                        <div className="col-sm-12">
                          <div className="col-sm-6 pull-left" id="trandate">
                          ...
                          <div className="col-sm-6 pull-left" id="tranledger">
                            <div className="form-group">
                              <label
                                htmlFor="textfield"
                                className="control-label col-sm-3"
                              ...
                              <div className="col-sm-9">
                                <select
                                  ...
                                  defaultValue={
                                    paymentData[0].credit_blnc_bfore_txn
                                  }
                                >
                          ...
                          <div className="col-sm-6 pull-left" id="tranmode">
                            <div className="form-group">
                              <label
                                htmlFor="textfield"
                                className="control-label col-sm-3"
                          ...
                          {neftState === 1 && (
                            <div className="col-sm-6 pull-left" id="ac_no">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {neftState === 1 && (
                            <div className="col-sm-6 pull-left" id="bankname">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {chequeState === 1 && (
                            <div className="col-sm-6 pull-left" id="chequedate">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {chequeState === 1 && (
                            <div className="col-sm-6 pull-left" id="cheque_no">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {neftState === 1 && (
                            <div className="col-sm-6 pull-left" id="branch">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {(chequeState === 1 || neftState === 1) && (
                            <div className="col-sm-6 pull-left" id="banks">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {(cashState === 1 ||
                            chequeState === 1 ||
                            neftState === 1) && (
                            <div className="col-sm-6 pull-left" id="amnt">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {(cashState === 1 ||
                            chequeState === 1 ||
                            neftState === 1) && (
                            <div className="col-sm-6 pull-left" id="desc">
                              <div className="form-group">
                                <label
                                  htmlFor="textfield"
                                  className="control-label col-sm-3"
                          ...
                          {/* <div className="col-sm-6 pull-left" id="deb">
                            <div className="form-group">
                              <label
                                htmlFor="textfield"
                                className="control-label col-sm-3"
