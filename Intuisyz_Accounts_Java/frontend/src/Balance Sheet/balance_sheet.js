...
const Balance_sheet = () => {
  ...
  const submitFinal = handleSubmit(async (data) => {
    if (startDate === null || startDate === undefined) {
      ...
      ssdate.setMonth(3);
      ssdate.setDate(1);
      let mnth = endDate.getMonth();
      if (mnth === 0 || mnth === 1 || mnth === 2) {
        // If month of end date is Jan OR Feb OR Mar
        ssdate.setFullYear(endDate.getFullYear() - 1);
      } else {
        ssdate.setFullYear(endDate.getFullYear());
      }

      if (ssdate.getDate() < 10) {
        var currentDay = '0' + ssdate.getDate();
      } else {
        var currentDay = ssdate.getDate();
      }

      if (ssdate.getMonth() + 1 < 10) {
        var currentMonth = '0' + (ssdate.getMonth() + 1);
      } else {
        var currentMonth = ssdate.getMonth() + 1;
      }

      var sDate = ssdate.getFullYear() + '-' + currentMonth + '-' + currentDay;
      ...
      console.log('line 286 sDate ',sDate, ' eDate ', eDate);
      ...
      try {
        ...
        console.log('line 356 currentLabilityAmount', result6);
        setCurrentLabilityAmountData(result6);
  ...
  const filterFun = async () => {
    ...
    console.log('line 440 startdate ', startdate,' enddate ', enddate);
    console.log('line 441 dateVal ',dateVal);

    if (dateVal === '0' || dateVal === '5') {
      //This Month and default
      ...
      console.log('line 461 startdate',startdate,'line 500 enddate',enddate);
    }
    ...
    if (dateVal === '1') {
      ...
      console.log('line 498 startdate',startdate,' enddate',enddate);
    }
    ...
    console.log('line 572 sDate ',sDate, ' eDate ', eDate);
    ...
    try {
      ...
      console.log('line 595 currentLabilityAmount', result6);
      setCurrentLabilityAmountData(result6);
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                if (e.target.value === '4') {
                                  ...
                                  setCustomFlag(false);
                                  localStorage.setItem('BalanceSheetDateFilter', e.target.value);
