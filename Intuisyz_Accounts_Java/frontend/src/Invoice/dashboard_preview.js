...
const Dashboard_preview = () => {
  ...
  function pdfFunNew() {
    ...
    finalObj1.totalAmnt =
      ...
      console.log('line 283 invoiceData ',invoiceData);
      console.log('line 284 finalObj1 ',finalObj1);
      console.log('line 285 profileData ',profileData);
      console.log('line 286 CompanyName ',sessionStorage.getItem('CompanyName'));
      console.log('line 288 CustId ',sessionStorage.getItem('CustId'));
      console.log('line 289 gstIdVal ',sessionStorage.getItem('gstIdVal'));
      console.log('line 290 tdsIdVal ',sessionStorage.getItem('tdsIdVal'));
      console.log('line 291 cashIdVal ',sessionStorage.getItem('cashIdVal'));
      console.log('line 292 logDetails ',sessionStorage.getItem('logDetails'));
    ...
    axios
      ...
      .then((data) => {
        console.log(`line 316 Invoice download data`, data);
