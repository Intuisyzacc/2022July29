...
const Create_profile = () => {
  ...
  const submitFinal = handleSubmit((data) => {
    ...
    let finalObj1 = {};
    finalObj1.organization_id = profileData[0].organization_id;
    ...
    let finalObj6 = {};
    finalObj6.template_id = templateData[0].template_id;
  ...
  function uploadDataFun(file) {
    ...
    var fileInput = document.getElementById('upload123');
  ...
  function uploadLogoDataFun(file) {
    ...
    // var fileInput = document.getElementById('upload1234').value;
    // var filePath = fileInput.value;

    var fileInput = document.getElementById('upload1234');
    var filePath = fileInput.value;
    var allowedExtensions = /(\.jpg|\.jpeg|\.png)$/i;
    if (!allowedExtensions.exec(filePath)) {
      alert('Please upload file having extensions .jpeg/.jpg/.png/.gif only.');
  ...
  const uploadImage = async (file) => {
    if (logoUploadFlag === true) {
      var fileInput = document.getElementById('upload1234');
    }

    if (signUploadFlag === true) {
      var fileInput = document.getElementById('upload123');
    }
    var filePath = fileInput.value;
    var allowedExtensions = /(\.jpg|\.jpeg|\.png)$/i;
  ...
  return (
    <div>
      ...
      {templateDataLoaded && profileDataLoaded ? (
        <div>
          <div>
            <div class="container" style={{ paddingLeft: ' 220px' }}>
              <form>
                <br></br>
                    ...
                    >
                      ...
                      {logoImageLoaded ? (
                        ...
                        <img
                          ...
                          id="logoimg"
                          alt="Select One"
                          style={{ width: 'fit-content', maxHeight: '60px' }}
                        />
                      )}

                      <div className="guideLinesForLogo">
                        <h5>
                          <b>Logo Upload Guidelines</b>
                        </h5>
                        <p>
                          Your logo will be displayed (if you chose to): on all
                          your documents (Invoices, Profile, View Statements)
                          Your Logo must meet these guidelines for better
                          alignments
                        </p>
                        <ol>
                          <li>
                            Image should be without bleed or outer space around
                            the Logo.
                          </li>
                          <li>jpg, Jpeg or PNG format</li>
                          <li>and preferably be on a white background</li>
                        </ol>
                      </div>
                    </div>
                  </div>
