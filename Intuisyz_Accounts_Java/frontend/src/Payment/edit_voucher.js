      ...
      if (
        ...
        axios
          ...
          .then(({ data }) => {
            ...
            console.log('line 251 crdtAmountac',crdtAmountac);
            ...
            if (Mode === 'cash') {
              ...
              console.log('line 1369 ledgerID11',ledgerID11);
              ...
              axios
                ...
                .then(({ data }) => {
                  ...
                  finalObj1.credit_blnc_bfore_txn = finalAmount;
                  finalObj1.credit_blnc_after_txn = parseFloat(finalAmount) - parseFloat(finalObj1.amount);
              ...
              axios
                ...
                .then(({ data }) => {
                  console.log('line 346 data ',data);
                  console.log('line 347 crdtAmountac',crdtAmountac);
                  ...
                  finalObj1.debit_blnc_after_txn = parseFloat(finalAmount1) - parseFloat(finalObj1.amount);
              ...
              axios
                .get(url + `ledger_search?ledgerId=${crdtAmountac}`)
                .then(({ data }) => {
                  console.log('ine 493 data ',data);
                  console.log('line 494 crdtAmountac',crdtAmountac);
                  ...
                  finalObj1.debit_blnc_bfore_txn = finalAmount1;
                  finalObj1.debit_blnc_after_txn = parseFloat(finalAmount1) - parseFloat(finalObj1.amount);
      ...
      if (
        ...
        axios
          ...
          .then(({ data }) => {
            ...
            let crdtAmountac = data[0].dbt_ac;
            let bankledger = data[0].bank;
            console.log('line 814 crdtAmountac',crdtAmountac);
            ...
            if (Mode === 'cash') {
              ...
              axios
                .get(url + `ledger_search?ledgerId=${crdtAmountac}`)
                .then(({ data }) => {
                  console.log('line 913 data ',data);
                  console.log('line 914 crdtAmountac',crdtAmountac);
              ...
              axios
                .get(url + `ledger_search?ledgerId=${crdtAmountac}`)
                .then(({ data }) => {
                  console.log('line 1061 data ',data);
                  console.log('line 1062 crdtAmountac',crdtAmountac);
          ...
          .then(({ data }) => {
            ...
            if (Mode === 'cash') {
              ...
              axios
                .get(url + `ledger_search?ledgerId=${crdtAmountac}`)
                .then(({ data }) => {
                  console.log('line 1463 data ',data);
                  console.log('line 1464 crdtAmountac',crdtAmountac);
              ...
              axios
                .get(url + `ledger_search?ledgerId=${crdtAmountac}`)
                .then(({ data }) => {
                  console.log('line 1611 data ',data);
                  console.log('line 1612 crdtAmountac',crdtAmountac);
