...
const Add_ledger = (props) => {
  ...
  const submitFinal = handleSubmit((data) => {
    console.log('line 90 data.group_name ',data.group_name);
    console.log('line 91 data ',data);
    ////////////////////////Date and Time /////////////////////////////////
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        if (finalObj.ac_type === '1' || finalObj.ac_type === '3') // ledger created under asset type or income type
        {
          finalObj.balance_type = 'debit';
        }
        else if (finalObj.ac_type === '2' || finalObj.ac_type === '4') // ledger created under liabilty type or expense type
        {
          finalObj.balance_type = 'credit';
        }
