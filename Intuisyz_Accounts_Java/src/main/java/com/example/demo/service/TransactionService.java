...
//	  
    ...
    public List<Account_transactions_v3> list_transactions(String CompanyName,String CustId)  {
		
		
		List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectData(CompanyName,CustId);
...
//	    	ob.setAc_type(acType);
  ...
  public List<Account_transactions_v3> transaction_sorts(String field, String type,String CompanyName,String CustId)  {
		...
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_DateA(CompanyName,CustId);
		}
		
		if(field.equals("tran_Date")&&type.equals("DESC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_DateD(CompanyName,CustId);
		}
		
		if(field.equals("dbt_ac")&&type.equals("ASC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_acA(CompanyName,CustId);
		}
		
		if(field.equals("dbt_ac")&&type.equals("DESC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_acD(CompanyName,CustId);
		}
		
		if(field.equals("mode")&&type.equals("ASC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.modeA(CompanyName,CustId);
			
		}
		
		if(field.equals("mode")&&type.equals("DESC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.modeD(CompanyName,CustId);
			
		}
		
		if(field.equals("amount")&&type.equals("ASC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.amountA(CompanyName,CustId);
		}
		
		if(field.equals("amount")&&type.equals("DESC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.amountD(CompanyName,CustId);
		}
		
		if(field.equals("description")&&type.equals("ASC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.descriptionA(CompanyName,CustId);
		}
		
		if(field.equals("description")&&type.equals("DESC"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.descriptionD(CompanyName,CustId);
		}
    ...
    public List<Account_transactions_v3> payment_bn_dates(String start, String end,String CompanyName,String CustId)  {
		
		System.out.println("start"+start+"end"+end);
		List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectDataBnDate(start,end,CompanyName,CustId);
...
public List<Account_transactions_v3> list_journals(String CompanyName,String CustId)  {
	
	
		List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectDataJournal(CompanyName,CustId);
...
public List<Account_transactions_v3> journal_sorts(String field, String type,String CompanyName,String CustId)  {
	...
	if(field.equals("tran_Date")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_Date_journalA(CompanyName,CustId);
	}
	
	if(field.equals("tran_Date")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_Date_journalD(CompanyName,CustId);
	}
	
	if(field.equals("dbt_ac")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_ac_journalA(CompanyName,CustId);
	}
	
	if(field.equals("dbt_ac")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_ac_journalD(CompanyName,CustId);
	}
	
	if(field.equals("crdt_ac")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.crdt_ac_journalA(CompanyName,CustId);
		
	}
	
	if(field.equals("crdt_ac")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.crdt_ac_journalD(CompanyName,CustId);
		
	}
	
	if(field.equals("amount")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.amount_journalA(CompanyName,CustId);
	}
	
	if(field.equals("amount")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.amount_journalD(CompanyName,CustId);
	}
	
	if(field.equals("description")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.description_journalA(CompanyName,CustId);
	}
	
	if(field.equals("description")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.description_journalD(CompanyName,CustId);
	}
...
public List<Account_transactions_v3> journal_bn_dates(String start, String end,String CompanyName,String CustId)  {
	
	System.out.println("start"+start+"end"+end);
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectJournalDataBnDate(start,end,CompanyName,CustId);
...
public List<Account_transactions_v3> list_receipts(String CompanyName,String CustId)  {
	
	
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectDataReceipt(CompanyName,CustId);
...
public List<Account_transactions_v3> receipt_sorts(String field, String type,String CompanyName,String CustId)  {
	...
	if(field.equals("tran_Date")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_DateReceiptA(CompanyName,CustId);
	}
	
	if(field.equals("tran_Date")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.tran_DateReceiptD(CompanyName,CustId);
	}
	
	if(field.equals("dbt_ac")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_acReceiptA(CompanyName,CustId);
	}
	
	if(field.equals("dbt_ac")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.dbt_acReceiptD(CompanyName,CustId);
	}
	
	if(field.equals("mode")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.modeReceiptA(CompanyName,CustId);
		
	}
	
	if(field.equals("mode")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.modeReceiptD(CompanyName,CustId);
		
	}
	
	if(field.equals("amount")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.amountReceiptA(CompanyName,CustId);
	}
	
	if(field.equals("amount")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.amountReceiptD(CompanyName,CustId);
	}
	
	if(field.equals("description")&&type.equals("ASC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.descriptionReceiptA(CompanyName,CustId);
	}
	
	if(field.equals("description")&&type.equals("DESC"))
	{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.descriptionReceiptD(CompanyName,CustId);
	}
...
public List<Account_transactions_v3> receipt_bn_dates(String start, String end,String CompanyName,String CustId)  {
	
	System.out.println("start"+start+"end"+end);
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectReceiptDataBnDate(start,end,CompanyName,CustId);
...
public List<Account_ledger_v3> list_account_statements(String CompanyName,String CustId)  {
	
	
	List<String> li1=(List<String>) transactionServiceRepo.selectDbt_account_statements(CompanyName,CustId);
	
	System.out.println("transaction dbt"+li1);
	
	List<String> li2=(List<String>) transactionServiceRepo.selectCrdt_account_statements(CompanyName,CustId);
    ...
    for(int k=0; k<li.size(); k++) {
    	...
    	System.out.println(Integer.parseInt(li.get(k))+" id number");
    
    List<Account_ledger_v3> li3=(List<Account_ledger_v3>) ledgerServiceRepo.getLedgers(Integer.parseInt(li.get(k)));
    
    System.out.println(Integer.parseInt(li.get(k))+" li3 size after searching"+li3.size());
...
public List<Account_transactions_v3> accStmtTransactions(String id, String description,String CompanyName,String CustId)  {
	
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectAccStmtTransaction(id,description,CompanyName,CustId);
...
public List<Account_transactions_v3> accStmtTransactionBnDates(String id, String description,String start, String end,String CompanyName,String CustId)  {
	
	
	
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.selectAccStmtTransactionBndates(id,description,start,end,CompanyName,CustId);
		...
		{  
			...
			balance_type=li.get(i).getBalance_type();
			 ...
			 if (balance_type.equals("debit")) {
	 	      ...
	 	      System.out.println("Debit total "+debit_total1);
			   System.out.println("Credit total  "+credit_total1);
	 	      if(li.get(i).getOpen_balance().equals(""))
	 	      {
		 ...
		 System.out.println("line 1001 balance_type  "+balance_type);
...
// }
 ...
 if (li1.get(i).getType().equals("Receipt"))
 {
	 particular=Integer.parseInt(li1.get(i).getCrdt_ac());
 }
 else
...
public List<Account_transactions_v3> bankBookAccount_statementDatas(int ledgerId)  {
		System.out.println(ledgerId);
...
public List<Account_transactions_v3> bankBookData(String CompanyName,String CustId)  {
	...
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.bankBookDatas(CompanyName,CustId);
	  ...
	  System.out.println("li.size() "+ li.size());
		...
		for (int i = 0; i < li.size(); i++)   
			...
			System.out.println("li account_transactions_v3 Type "+li.get(i).getType());
			System.out.println("li account_transactions_v3 branch "+li.get(i).getBranch());
			System.out.println("i = "+i);   
			List<Account_ledger_v3> li1=(List<Account_ledger_v3>) ledgerServiceRepo.getLedgers(Integer.parseInt(li.get(i).getDbt_ac()));
            List<Account_ledger_v3> li2=(List<Account_ledger_v3>) ledgerServiceRepo.getLedgers(Integer.parseInt(li.get(i).getCrdt_ac()));
			System.out.println("li1.size() "+ li1.size());
			System.out.println("li2.size() "+ li2.size());
			System.out.println("li account_transactions_v3 Debit Account "+li.get(i).getDbt_ac());
			System.out.println("li account_transactions_v3 Credit Account "+li.get(i).getCrdt_ac());
            if(li1.size()>0)
  		    {
				  System.out.println("li account_transactions_v3 Branch before setBranch() "+li.get(i).getBranch());
				  System.out.println("li1 account_ledger_v3 ledger_name "+li1.get(0).getLedger_name());
				  
				  if (li.get(i).getType().equals("Receipt"))
				  {
					  System.out.println("li2 account_ledger_v3 ledger_name "+li2.get(0).getLedger_name());
					  li.get(i).setBranch(li2.get(0).getLedger_name());
					  System.out.println("li account_transactions_v3 Branch after setBranch() "+li.get(i).getBranch());
				  }
				  else
				  {
					  li.get(i).setBranch(li1.get(0).getLedger_name());
				  ...
				  System.out.println("li account_transactions_v3 Type "+li.get(i).getType());
			  System.out.println("li account_transactions_v3 Branch after setBranch() "+li.get(i).getBranch());
			  System.out.println("li account_transactions_v3 Amount "+li.get(i).getAmount());
          /*	if(li.get(i).getType().equals("Receipt"))
			  {
				  li.get(i).setBranch(li1.get(0).getLedger_name());
			  }*/
            ...
            //li.get(i).setAmount(li1.get(0).getAmount());
			System.out.println("li1 account_ledger_v3 Account grp "+li1.get(0).getAc_group());
			System.out.println("li1 account_ledger_v3 Account Title "+li1.get(0).getAc_title());
			System.out.println("li1 account_ledger_v3 Balance type "+li1.get(0).getBalance_type());
			System.out.println("li1 account_ledger_v3 Ledger Name "+li1.get(0).getLedger_name());
			System.out.println("li1 account_ledger_v3 Amount "+li1.get(0).getAmount());
			System.out.println("li1 account_ledger_v3 Ledger Id "+li1.get(0).getId());
			balance_type=li1.get(0).getBalance_type();
			System.out.println("Balance type "+balance_type);

			if (li.get(i).getType().equals("Receipt"))
			{
				 
			    if(li1.get(0).getOpen_balance().equals(""))
	 	 	      {
			    	 debit_total1 +=(float) 0;
	 	 	      }
	 	 	      else
	 	          ...
	 	          debit_total1 += Float.parseFloat(li.get(i).getAmount());   
	 	          
	 	 	      }
	 	          
	 	    }
	 	    if (li.get(i).getType().equals("Voucher"))
			{
	 	          ...
	 	          credit_total1 += Float.parseFloat(li.get(i).getAmount()); 
				...
				System.out.println("Debit total "+debit_total1);
				System.out.println("Credit total "+credit_total1);
				if (li.get(i).getType().equals("Nill"))
				{
					balance += Float.parseFloat(li.get(i).getAmount());
				}
				else
				{
					if (li.get(i).getType().equals("Voucher"))
				...
				li.get(i).setBank(Float.toString(balance));
				System.out.println("li account_transactions_v3 Bank "+li.get(i).getBank());
          }
		}
		System.out.println("li account_transactions_v3 "+li);
...
public List<Account_transactions_v3> bankBookOpenBalanceDataB(String id, String description,String start, String end,String CompanyName,String CustId)  {
...
public List<Account_transactions_v3> bankBookDataB(int ledgerId,String start,String end,String CompanyName,String CustId)  {
...
//	return li;
	...
	System.out.println("ledgerId "+ledgerId);
		...
		{  
			...
			System.out.println("li.get(i).getAc_group() "+li.get(i).getAc_group());
			...
			balance_type=li.get(i).getBalance_type();
			 ...
			 if (balance_type.equals("debit")) {
	 	      ...
	 	      System.out.println("debit_total1 "+debit_total1+"  "+"credit_total1 "+credit_total1);
		 ...
		 System.out.println("line 2755 balance_type  "+balance_type);
...
List<Account_transactions_v3> li1=(List<Account_transactions_v3>) transactionServiceRepo.selectAccStmtTransaction2Bndates(ledgerId,description,start,end,CompanyName,CustId);
...
System.out.println("line 2794 li1.size() "+li1.size());
...
//   System.out.println("Crdt_ac  "+ li1.get(i).getCrdt_ac());
               ...
               if (li1.get(i).getDbt_ac().equals( ledger_id)) {
   	                ...
   	                if (balance_type.equals("debit")) {
						System.out.println("li1.get(i).getDbt_ac() "+li1.get(i).getDbt_ac()+"ledger_id "+ledger_id);
               ...
               if (li1.get(i).getCrdt_ac().equals(ledger_id)) {
	                ...
	                if (balance_type.equals("debit")) {
						System.out.println("li1.get(i).getCrdt_ac() "+li1.get(i).getCrdt_ac()+"ledger_id "+ledger_id);
	                 												System.out.println("debit");
...
public List<Account_transactions_v3> dayBookData(String CompanyName,String CustId)  {
	
	  
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDatas(CompanyName,CustId);
...
public List<Account_transactions_v3> debitAcData(String CompanyName,String CustId)  {
	
	  
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.debitAcDatas(CompanyName,CustId);
...
public List<Account_transactions_v3> creditAcData(String CompanyName,String CustId)  {
	
	  
	List<Account_transactions_v3> li=(List<Account_transactions_v3>) transactionServiceRepo.creditAcDatas(CompanyName,CustId);
...
public List<Account_transactions_v3> daybook_sorts(String field, String type,String CompanyName,String CustId)  {
	...
	{
		li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDatas(CompanyName,CustId);
	}
...
public List<Account_transactions_v3> dayBookDataBnDate(String start,String end,String debit,String credit,String CompanyName,String CustId)  {
	...
	if(!debit.equals("null") && !credit.equals("null") &&  !debit.equals(credit))
		{
		 li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDataBnDate1(start,end,debit,credit,CompanyName,CustId);
		
		}
		if(!debit.equals("null") && !credit.equals("null") && debit.equals(credit))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDataBnDate2(start,end,debit,credit,CompanyName,CustId);
			
		}
		
       if(!debit.equals("null") && credit.equals("null"))
		{
    	   li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDataBnDate3(start,end,debit,CompanyName,CustId);
   		
		}
		if(debit.equals("null") && !credit.equals("null"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDataBnDate4(start,end,credit,CompanyName,CustId);
	   		
		}
		if(debit.equals("null") && credit.equals("null"))
		{
			 li=(List<Account_transactions_v3>) transactionServiceRepo.dayBookDataBnDate5(start,end,CompanyName,CustId);
...
public List<Account_transactions_v3> transactionHistory_searchs(String start,String end,String debit,String credit,String field,String val,String CompanyName,String CustId)  {
